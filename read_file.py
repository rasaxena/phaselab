...
def linear_interpolate(sim_dist,sim_dose,meas_dist):
    ...
    for inx in meas_dist:
        ...
        if y-x != 0:
            ...
            # print(x,y,a,b)
            # print(slope)
            sim_interpolated_meas = abs(inx)*abs(slope)
            print('slope' + str(slope))
...
# print('BLING')
print(new_sim_dose)
new_sim_dose = normalize_dose(new_sim_dose)
print('BANANA')
...
gamma = calc_gamma(new_sim_dose,new_sim_dist,np_meas_dose,meas_dist)
...
# print(new_sim_dist)
# print(new_sim_dose)
ax.scatter(new_sim_dist, new_sim_dose, color='r', s=s/10, alpha=.4)
# ax.scatter(meas_dist, np_meas_dose, color='b', s=s/10, alpha=.4)
# ax.scatter(meas_dist,gamma, color='g', s=s/3, marker='s', alpha=.4)
plt.show()
